...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- DATA FETCHER FOR ALL DESTINATIONS ---
    const destinationsContainer = document.getElementById('all-destinations-grid');
    if (destinationsContainer) {
        destinationsContainer.innerHTML = '<p class="text-center col-span-full">Loading destinations...</p>';

        // Get ALL documents from the 'destinations' collection
